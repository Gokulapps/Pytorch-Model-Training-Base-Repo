...
def get_mean_and_std(data, no_channels):
    try:
        ...
        print(e)
        print(f'Error in {get_mean_and_std.__name__} Block')
...
def visualize_images(images, target, classes=None, fig_size=(6.4, 4.8)):
    try:
        ...
        print(e)
        print(f'Error in {visualize_images.__name__} Block')
...
def classwise_accuracy(model, train_loader, classes, device):
    try:
        ...
        print(e)
        print(f'Error in {classwise_accuracy.__name__} Block')
...
def model_summary(model, input_size):
    try:
        ...
        print(e)
        print(f'Error in {model_summary.__name__} Block')
...
def plot_graph(train_loss, train_acc, test_loss, test_acc, fig_size=(15,10)):
    try:
        ...
        axs[0][0].plot(train_loss.cpu(), color='yellow')
        axs[0][0].set_title("Train Loss")
        axs[0][0].set_xlabel('Number of Epoch')
        axs[0][0].set_ylabel('Loss')
        axs[0][1].plot(test_loss.cpu(), color='red')
        axs[0][1].set_title("Validation Loss")
        axs[0][1].set_xlabel('Number of Epoch')
        axs[0][1].set_ylabel('Loss')
        axs[1][0].plot(train_acc.cpu(), color='yellow')
        axs[1][0].set_title("Train Accuracy")
        axs[1][0].set_xlabel('Number of Epoch')
        axs[1][0].set_ylabel('Accuracy(%)')
        axs[1][1].plot(test_acc.cpu(), color='red')
        ...
        print(e)
        print(f'Error in {plot_graph.__name__} Block')
...
def Gradcam(model, input_tensor, target_layer, part, device, target):
    try:
        ...
        print(e)
        print(f'Error in {Gradcam.__name__} Block')
